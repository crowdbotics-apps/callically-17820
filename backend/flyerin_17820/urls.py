"""flyerin_17820 URL Configuration
...
admin.site.site_header = "FLYERIN"
admin.site.site_title = "FLYERIN Admin Portal"
admin.site.index_title = "FLYERIN Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="FLYERIN API",
        default_version="v1",
        description="API documentation for FLYERIN App",
    ),
    public=True,
